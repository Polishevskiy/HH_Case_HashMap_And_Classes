...
## HH Case HashMap and Classes
```sh
1. open your resume at the link 
2. Get information about the profile using HashMap or Class, which must have the following attributes: 
String sex, int age, String city, confirmedPhoneNumber boolean, readyToRelocate boolean. 
3. Make sure the expected and actual result are equal 
```
